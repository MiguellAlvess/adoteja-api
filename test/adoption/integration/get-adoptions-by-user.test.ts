...
import { GetAdoptionsByUser } from "../../../src/application/usecase/adoption/get-adoptions-by-user.js"
...
describe("Get Adoptions By User", () => {
  ...
  let getAdoptionsByUser: GetAdoptionsByUser
  ...
  beforeAll(async () => {
    ...
    getAdoptionsByUser = new GetAdoptionsByUser(adoptionRepository)
  })
  ...
  test("should get user adoptions", async () => {
    ...
    const output = await getAdoptionsByUser.execute(adopterOutput.userId)
